...
public class Player : Actor
{
	...
	public override void Render()
	{
		...
		Sprite.RenderPosition = Sprite.RenderPosition.Floor_Fixed();
	...
	{
		Vector2 vector = (boostTarget - base.Collider.Center).Floor_Fixed();
		MoveToX(vector.X);
		MoveToY(vector.Y);
	}
	...
	{
		this.attractTo = attractTo.Round_Fixed();
