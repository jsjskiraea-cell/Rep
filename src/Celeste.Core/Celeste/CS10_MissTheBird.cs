...
public class CS10_MissTheBird : CutsceneEntity
{
	...
	private sealed class _003CCutscene_003Ed__8 : IEnumerator<object>, IDisposable, IEnumerator
	{
		...
		private bool MoveNext()
		{
			...
			case 2:
				...
				level.ResetZoom();
				level.Shake(0.5f);
				CS_0024_003C_003E8__locals44.player.Position = CS_0024_003C_003E8__locals44.player.Position.Floor_Fixed();
	...
	public override void OnEnd(Level level)
	{
		...
		if (WasSkipped)
		{
			...
			if (cutsceneNode != null)
			{
				player.Position = cutsceneNode.Position.Floor_Fixed();
