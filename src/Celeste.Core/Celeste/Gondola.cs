...
public class Gondola : Solid
{
	private class Rope : Entity
	{
		...
		{
			Vector2 vector = (Gondola.LeftCliffside.Position + new Vector2(40f, -12f)).Floor_Fixed();
			Vector2 vector2 = (Gondola.RightCliffside.Position + new Vector2(-40f, -4f)).Floor_Fixed();
