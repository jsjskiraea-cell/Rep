...
public class Engine : Game
{
	...
	// Plataforma - injetada pela camada host (Android/Kotlin) antes de iniciar o Engine
	...
	/// <summary>
	/// Set the platform paths implementation. Must be called by the host before loading content.
	/// </summary>
